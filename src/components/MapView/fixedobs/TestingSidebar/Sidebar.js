               ...
               <div>
                  {
                    clickPlots ?
                    (<div>
                        {/* Aqui mandamos la url, url_descarga, y si es perfil o no, en la otra vista se llama a django para traer las cosas. */}
                        <FixedObsPlotsSidebar url={statusPlot.url} url_download={statusPlot.url_download} is_profile={filesData ? filesData.site.isprofile: null}/>
                    </div>)
                    :
                    null
                  }
